# SAV Daily English — App Store / Google Play 描述文案

> 適用：App Store Connect（iOS）+ Google Play Console（Android）
...
**Daily Listening · Speaking · AI Review**
...
**SAV Daily English — Your Daily English Training Partner**
...
Unlike subscription apps, SAV Daily English is a one-time purchase with no recurring fees. The full 53-week, 365-day curriculum is included. Start any day: your first day becomes Day 1, and the program rolls forward from there for 365 days.
...
**一整年內容，一次購買**
與訂閱制 App 不同，SAV Daily English 買斷無月費。完整 53 週、365 天課程全部包含。任何一天開始都行：開始使用的那天就是 Day 1，課程會從那一天起往後連續展開 365 天。
...
## Keywords（Apple App Store 關鍵字，100 字元以內，逗號分隔）

```
english,learning,podcast,speaking,fluency,TOEIC,TOEFL,ESL,vocabulary,listening,daily,practice,AI,conversation,flashcard
```

---

## What's New（更新說明，v1.0 首版）

### English
Welcome to SAV Daily English! This is the initial release featuring the complete 53-week, 365-day curriculum with Listen, Speak, Conversation, and Review modules. Start your daily English practice today.

### 中文
歡迎使用 SAV Daily English！這是首次發布版本，包含完整 53 週、365 天課程，以及聆聽、口說、對話和複習四大模組。立即開始你的每日英語練習。
...
> AI Credits Pack（10 credits）: 建議同樣設 NT$60 / $1.99 USD

---

## Age Rating Questions（Apple）
