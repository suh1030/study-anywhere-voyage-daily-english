    ...
    parts: [
      {
        ...
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When "Working Together: Office Relationships" comes up, what part of it feels grounded in ordinary life instead of sounding like a slogan?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I usually begin with working together, because that is where "Working Together: Office Relationships" stops being abstract and starts touching actual routines.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'working together', def: '一起工作' }] },
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'For me it shows up in small moments rather than dramatic ones. It starts becoming visible when the day is already moving and I still have to decide how to respond.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'office relationships', def: '職場關係' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That makes sense, because themes like "Colleagues & Teamwork" usually reveal themselves in the tone of a day before they become a clear idea.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'Yes, and that is why "Working Together: Office Relationships" feels meaningful to me. It asks what keeps shaping my decisions even when I do not feel especially motivated or clear.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Why do you think people often misjudge "Working Together: Office Relationships" in the beginning? Is it because they focus on outcomes before they understand the process?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Probably both. People often look for a dramatic sign, but a lot of "Working Together: Office Relationships" is made of repeated choices that are easy to dismiss while they are still small.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'Can you describe the situation a little more? I want to understand what turned "Working Together: Office Relationships" from a nice idea into a real demand.', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
          { speaker: 'a', speakerName: 'Lily', en: 'At the center of it was daily pattern. I remember realizing that the hard part was not understanding the issue; it was acting in line with what I already knew.', zh: '當時的核心其實是一個很具體的情境。表面上事情不大，但我能明顯感覺到舒適和對齊之間的拉扯。', vocab: [{ word: 'daily pattern', def: '日常習慣模式' }] },
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'Right, and that is probably why this matters here. It turns the topic into a practice instead of leaving it as a mood or identity label.', zh: '這樣很有道理，因為這種轉變通常不是靠一次衝很猛，而是靠誠實而穩定的重複慢慢練出來。', vocab: [{ word: 'small decision', def: '日常小決定' }] },
          { speaker: 'a', speakerName: 'Lily', en: 'Yes, and that is what stayed with me. Once small decision became part of my ordinary rhythm, the topic felt less dramatic but much more trustworthy.', zh: '對我來說，重要的轉折就在這裡。當這個改變真的進入日常節奏，整個主題就不再只是想法，而是可以依靠的結構。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'I would say quiet pressure. That is where the topic stops being intellectually interesting and starts requiring emotional maturity in real time.', zh: '最難的通常不是表面上的問題，而是它會在最不方便的時候要求你拿出耐心和成熟。', vocab: [{ word: 'quiet pressure', def: '無形的壓力' }] },
      ...
      },
      {
        ...
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'These days I handle "Working Together: Office Relationships" by focusing on process. I care less about sounding wise and more about doing one repeatable thing well.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'For me, the first step is honest reset. It sounds modest, but it creates enough structure that I am less likely to get lost in mood or impulse.', zh: '我通常會先從一個夠小、但能穩定重複的動作開始。它看起來不大，卻足以影響整天的方向。', vocab: [{ word: 'honest reset', def: '誠實地重新出發' }] },
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'I look for steady rhythm. If that is growing, I know the practice is doing real work even if the change is not exciting or obvious.', zh: '我會看自己面對同樣情境時，回應是不是變得更穩。真正的進步通常比較安靜，不是特別戲劇化。', vocab: [{ word: 'steady rhythm', def: '穩定的節奏' }] },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'Yes, and that is where real trade-off helps me. It gives me a concrete way to return when the day or season has pulled me off center.', zh: '而且只要我還能回到那種讓自己重新對齊的做法，我通常就能慢慢找回自己真正想成為的樣子。', vocab: [{ word: 'real trade-off', def: '真實的取捨' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That lands well for me. The conversation makes "Working Together: Office Relationships" feel human, durable, and much closer to everyday life than to self-improvement theater.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When you think about "Giving and Receiving Feedback at Work", what feels immediately real rather than merely inspirational?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me, feedback work is the clearest entry point. It shows how "Giving and Receiving Feedback at Work" appears before anyone gives it a polished explanation.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'feedback work', def: '工作中的回饋' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Where does that part of "Giving and Receiving Feedback at Work" become most visible to you: in your routine, in your relationships, or in the choices you make under pressure?', zh: '這種感覺通常會在什麼場景最明顯：獨處時、忙碌工作中，還是和親近的人互動時？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Usually it appears in a very ordinary moment. I notice this when I am making a small decision and realize it quietly shapes the rest of the day.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'giving receiving', def: '付出與接受' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'I get that. Subjects like "Colleagues & Teamwork" often show up as a feeling or pattern before people have good language for them.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why this topic stays with me. "Giving and Receiving Feedback at Work" becomes real when it continues to matter on an ordinary day, not only on a reflective one.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Do you think people usually misunderstand "Giving and Receiving Feedback at Work" because they expect clarity too early, or because they only notice the visible part of it?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I think people expect a neat turning point, when the truth is that "Giving and Receiving Feedback at Work" often grows through small decisions that do not look important at first.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'What made that moment stand out so clearly? It sounds like something about the situation exposed the deeper shape of "Giving and Receiving Feedback at Work".', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'What helps me now is treating "Giving and Receiving Feedback at Work" less like a grand identity project and more like a set of choices I can rehearse repeatedly.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'That feels like a strong place to end. "Giving and Receiving Feedback at Work" sounds less like an ideal image now and more like a way of living with honesty over time.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'If "Difficult Colleagues" showed up in your week tomorrow morning, which part of it would feel most familiar right away?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'My mind goes to difficult colleagues first, because that is where "Difficult Colleagues" becomes something I can observe instead of just admire.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'difficult colleagues', def: '難相處的同事' }] },
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'It often happens in a plain everyday scene. It becomes visible when I notice I am dreading an interaction and I ask myself whether I have ever really tried to understand that person's position.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'daily pattern', def: '日常習慣模式' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Right, and that is probably why "Colleagues & Teamwork" can sound broad on paper but feel surprisingly specific in a normal day.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'Exactly. What matters to me is that "Difficult Colleagues" is not just about intention; it is also about what keeps returning when life is busy, messy, or emotionally uneven.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'What do you think makes "Difficult Colleagues" hard to read at first: the fact that it is subtle, or the fact that people want immediate certainty?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Usually they want a clear before-and-after story, but "Difficult Colleagues" is often shaped by modest patterns that only become obvious after enough time has passed.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'a', speakerName: 'Lily', en: 'That is the useful part for me. When this is woven into ordinary routines, "Difficult Colleagues" starts feeling like a structure I can rely on.', zh: '對我來說，重要的轉折就在這裡。當這個改變真的進入日常節奏，整個主題就不再只是想法，而是可以依靠的結構。' },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'The most useful shift for me has been practical. I try to build "Difficult Colleagues" through repeatable behaviors rather than waiting for the perfect emotional state.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'I think that is the real takeaway. "Difficult Colleagues" is not about performing certainty; it is about returning to what is true often enough that it changes you.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When you think about "Leading and Being Led", what feels immediately real rather than merely inspirational?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me, leading led is the clearest entry point. It shows how "Leading and Being Led" appears before anyone gives it a polished explanation.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'leading led', def: '領導與被領導' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Where does that part of "Leading and Being Led" become most visible to you: in your routine, in your relationships, or in the choices you make under pressure?', zh: '這種感覺通常會在什麼場景最明顯：獨處時、忙碌工作中，還是和親近的人互動時？' },
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'I get that. Subjects like "Colleagues & Teamwork" often show up as a feeling or pattern before people have good language for them.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why this topic stays with me. "Leading and Being Led" becomes real when it continues to matter on an ordinary day, not only on a reflective one.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Do you think people usually misunderstand "Leading and Being Led" because they expect clarity too early, or because they only notice the visible part of it?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I think people expect a neat turning point, when the truth is that "Leading and Being Led" often grows through small decisions that do not look important at first.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'What made that moment stand out so clearly? It sounds like something about the situation exposed the deeper shape of "Leading and Being Led".', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'What helps me now is treating "Leading and Being Led" less like a grand identity project and more like a set of choices I can rehearse repeatedly.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'That feels like a strong place to end. "Leading and Being Led" sounds less like an ideal image now and more like a way of living with honesty over time.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When "Remote Work and Team Connection" comes up, what part of it feels grounded in ordinary life instead of sounding like a slogan?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I usually begin with team connection, because that is where "Remote Work and Team Connection" stops being abstract and starts touching actual routines.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'team connection', def: '團隊連結' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'In what situation do you feel this most strongly: when you are alone, when you are busy, or when someone asks you to explain yourself?', zh: '這種感覺通常會在什麼場景最明顯：獨處時、忙碌工作中，還是和親近的人互動時？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me it shows up in small moments rather than dramatic ones. It starts becoming visible when the day is already moving and I still have to decide how to respond.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'remote work', def: '遠端工作' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That makes sense, because themes like "Colleagues & Teamwork" usually reveal themselves in the tone of a day before they become a clear idea.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'Yes, and that is why "Remote Work and Team Connection" feels meaningful to me. It asks what keeps shaping my decisions even when I do not feel especially motivated or clear.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Why do you think people often misjudge "Remote Work and Team Connection" in the beginning? Is it because they focus on outcomes before they understand the process?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Probably both. People often look for a dramatic sign, but a lot of "Remote Work and Team Connection" is made of repeated choices that are easy to dismiss while they are still small.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'Can you describe the situation a little more? I want to understand what turned "Remote Work and Team Connection" from a nice idea into a real demand.', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
          { speaker: 'a', speakerName: 'Lily', en: 'At the center of it was daily pattern. I remember realizing that the hard part was not understanding the issue; it was acting in line with what I already knew.', zh: '當時的核心其實是一個很具體的情境。表面上事情不大，但我能明顯感覺到舒適和對齊之間的拉扯。', vocab: [{ word: 'daily pattern', def: '日常習慣模式' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Did that tension change your behavior right away, or did it first change the story you told yourself about what mattered?', zh: '那個拉扯是先改變了你的做法，還是先改變了你理解自己的方式？' },
          { speaker: 'a', speakerName: 'Lily', en: 'My mindset moved before the visible behavior did. That honesty made later decisions feel steadier, because I was no longer pretending the trade-off was easy.', zh: '真正先動的是內在。當我比較誠實地面對自己在逃避什麼之後，後面的選擇才慢慢變得比較穩。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Right, and that is probably why this matters here. It turns the topic into a practice instead of leaving it as a mood or identity label.', zh: '這樣很有道理，因為這種轉變通常不是靠一次衝很猛，而是靠誠實而穩定的重複慢慢練出來。', vocab: [{ word: 'small decision', def: '日常小決定' }] },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'These days I handle "Remote Work and Team Connection" by focusing on process. I care less about sounding wise and more about doing one repeatable thing well.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
          { speaker: 'b', speakerName: 'Tom', en: 'What is the first small action in that process? I want the version that still works when energy, confidence, and time are all imperfect.', zh: '如果今天就要開始做，你會說第一個最小、但真的有效的動作是什麼？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me, the first step is honest reset. It sounds modest, but it creates enough structure that I am less likely to get lost in mood or impulse.', zh: '我通常會先從一個夠小、但能穩定重複的動作開始。它看起來不大，卻足以影響整天的方向。', vocab: [{ word: 'honest reset', def: '誠實地重新出發' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'What does your strategy look like when the day is messy? I think that is where a practice either proves itself or quietly disappears.', zh: '那在狀態很差的日子呢？當你沒有動力，也沒有耐心的時候，這個做法還撐得住嗎？' },
          { speaker: 'a', speakerName: 'Lily', en: 'On bad days, I lower the standard without abandoning the direction. I would rather keep the thread alive than perform a perfect version once in a while.', zh: '撐得住的前提是把標準縮小，而不是整個放棄。我寧可保住那條線，也不要偶爾做一次非常完美的版本。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'That gives the whole topic a lot of dignity. It treats growth as something lived, not simply announced.', zh: '這樣的結論很有力量，因為它把成長當成被活出來的東西，而不是被宣告出來的東西。' },
          { speaker: 'a', speakerName: 'Lily', en: 'Yes, and that is where real trade-off helps me. It gives me a concrete way to return when the day or season has pulled me off center.', zh: '而且只要我還能回到那種讓自己重新對齊的做法，我通常就能慢慢找回自己真正想成為的樣子。', vocab: [{ word: 'real trade-off', def: '真實的取捨' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That lands well for me. The conversation makes "Remote Work and Team Connection" feel human, durable, and much closer to everyday life than to self-improvement theater.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When you think about "Meetings and Productivity", what feels immediately real rather than merely inspirational?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me, meetings productivity is the clearest entry point. It shows how "Meetings and Productivity" appears before anyone gives it a polished explanation.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'meetings productivity', def: '會議效率' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Where does that part of "Meetings and Productivity" become most visible to you: in your routine, in your relationships, or in the choices you make under pressure?', zh: '這種感覺通常會在什麼場景最明顯：獨處時、忙碌工作中，還是和親近的人互動時？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Usually it appears in a very ordinary moment. I notice this when I am making a small decision and realize it quietly shapes the rest of the day.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'daily pattern', def: '日常習慣模式' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'I get that. Subjects like "Colleagues & Teamwork" often show up as a feeling or pattern before people have good language for them.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why this topic stays with me. "Meetings and Productivity" becomes real when it continues to matter on an ordinary day, not only on a reflective one.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Do you think people usually misunderstand "Meetings and Productivity" because they expect clarity too early, or because they only notice the visible part of it?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I think people expect a neat turning point, when the truth is that "Meetings and Productivity" often grows through small decisions that do not look important at first.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'What made that moment stand out so clearly? It sounds like something about the situation exposed the deeper shape of "Meetings and Productivity".', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
          { speaker: 'a', speakerName: 'Lily', en: 'It involved small decision. I was trying to do the responsible thing, but I could also feel how easy it would have been to fall back into a more familiar pattern.', zh: '當時的核心其實是一個很具體的情境。表面上事情不大，但我能明顯感覺到舒適和對齊之間的拉扯。', vocab: [{ word: 'small decision', def: '日常小決定' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'When that happened, did your actions shift first, or did your language and self-understanding change before the behavior caught up?', zh: '那個拉扯是先改變了你的做法，還是先改變了你理解自己的方式？' },
          { speaker: 'a', speakerName: 'Lily', en: 'The real change began inside. I stopped trying to look impressive and started asking whether my choices could hold up on a normal, imperfect day.', zh: '真正先動的是內在。當我比較誠實地面對自己在逃避什麼之後，後面的選擇才慢慢變得比較穩。' },
          { speaker: 'b', speakerName: 'Tom', en: 'That sounds important, because quiet pressure usually grows more reliably through honest repetition than through one burst of intensity.', zh: '這樣很有道理，因為這種轉變通常不是靠一次衝很猛，而是靠誠實而穩定的重複慢慢練出來。', vocab: [{ word: 'quiet pressure', def: '無形的壓力' }] },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'What helps me now is treating "Meetings and Productivity" less like a grand identity project and more like a set of choices I can rehearse repeatedly.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'I like that conclusion, because it honors the quiet labor inside real change instead of reducing everything to a performance.', zh: '這樣的結論很有力量，因為它把成長當成被活出來的東西，而不是被宣告出來的東西。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why useful habit matters to me now. It is not a slogan; it is a practical doorway back into alignment whenever life becomes noisy.', zh: '而且只要我還能回到那種讓自己重新對齊的做法，我通常就能慢慢找回自己真正想成為的樣子。', vocab: [{ word: 'useful habit', def: '有用的習慣' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That feels like a strong place to end. "Meetings and Productivity" sounds less like an ideal image now and more like a way of living with honesty over time.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
    ...
    parts: [
      {
        title: 'Part 1 — Opening the Theme',
        lines: [
          { speaker: 'b', speakerName: 'Tom', en: 'When you think about "Professional Growth and Career Development", what feels immediately real rather than merely inspirational?', zh: '當你想到這個主題時，哪一部分最貼近真實生活，而不只是聽起來很勵志的想法？' },
          { speaker: 'a', speakerName: 'Lily', en: 'For me, career development is the clearest entry point. It shows how "Professional Growth and Career Development" appears before anyone gives it a polished explanation.', zh: '對我來說，最容易切入的是一個很具體的日常面向，因為它讓這個主題不再停留在抽象層次。', vocab: [{ word: 'career development', def: '職涯發展' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'Where does that part of "Professional Growth and Career Development" become most visible to you: in your routine, in your relationships, or in the choices you make under pressure?', zh: '這種感覺通常會在什麼場景最明顯：獨處時、忙碌工作中，還是和親近的人互動時？' },
          { speaker: 'a', speakerName: 'Lily', en: 'Usually it appears in a very ordinary moment. I notice this when I am making a small decision and realize it quietly shapes the rest of the day.', zh: '它常常出現在很普通的時刻。當我為了一個小選擇停下來時，就會看見它如何悄悄影響整天的方向。', vocab: [{ word: 'professional growth', def: '職業成長' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'I get that. Subjects like "Colleagues & Teamwork" often show up as a feeling or pattern before people have good language for them.', zh: '這很合理，因為這類主題往往先以一種感受或模式出現，之後人才慢慢找到語言去描述它。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why this topic stays with me. "Professional Growth and Career Development" becomes real when it continues to matter on an ordinary day, not only on a reflective one.', zh: '沒錯，所以這個主題對我來說不只是理念，而是它是否會在忙碌、混亂或情緒起伏時，繼續影響我的選擇。' },
          { speaker: 'b', speakerName: 'Tom', en: 'Do you think people usually misunderstand "Professional Growth and Career Development" because they expect clarity too early, or because they only notice the visible part of it?', zh: '你覺得大家一開始最容易誤判的是什麼：太急著要答案，還是只注意表面結果？' },
          { speaker: 'a', speakerName: 'Lily', en: 'I think people expect a neat turning point, when the truth is that "Professional Growth and Career Development" often grows through small decisions that do not look important at first.', zh: '我覺得兩者都有。很多人期待戲劇性的轉折，但真正的變化常常是由反覆的小選擇慢慢累積出來的。' }
        ],
      },
      {
        title: 'Part 2 — A Concrete Situation',
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'What made that moment stand out so clearly? It sounds like something about the situation exposed the deeper shape of "Professional Growth and Career Development".', zh: '可以多說一點那個情境嗎？我想知道，是什麼讓這個主題突然變得很個人、很難忽視。' },
          { speaker: 'a', speakerName: 'Lily', en: 'It involved daily pattern. I was trying to do the responsible thing, but I could also feel how easy it would have been to fall back into a more familiar pattern.', zh: '當時的核心其實是一個很具體的情境。表面上事情不大，但我能明顯感覺到舒適和對齊之間的拉扯。', vocab: [{ word: 'daily pattern', def: '日常習慣模式' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'When that happened, did your actions shift first, or did your language and self-understanding change before the behavior caught up?', zh: '那個拉扯是先改變了你的做法，還是先改變了你理解自己的方式？' },
          { speaker: 'a', speakerName: 'Lily', en: 'The real change began inside. I stopped trying to look impressive and started asking whether my choices could hold up on a normal, imperfect day.', zh: '真正先動的是內在。當我比較誠實地面對自己在逃避什麼之後，後面的選擇才慢慢變得比較穩。' },
          { speaker: 'b', speakerName: 'Tom', en: 'That sounds important, because small decision usually grows more reliably through honest repetition than through one burst of intensity.', zh: '這樣很有道理，因為這種轉變通常不是靠一次衝很猛，而是靠誠實而穩定的重複慢慢練出來。', vocab: [{ word: 'small decision', def: '日常小決定' }] },
      ...
      },
      {
        title: 'Part 4 — What Helps in Practice',
        lines: [
          { speaker: 'a', speakerName: 'Lily', en: 'What helps me now is treating "Professional Growth and Career Development" less like a grand identity project and more like a set of choices I can rehearse repeatedly.', zh: '現在我處理這個主題的方式，比較像在練一套可重複的選擇，而不是追求某種很好看的人設。' },
      ...
      },
      {
        ...
        lines: [
          ...
          { speaker: 'b', speakerName: 'Tom', en: 'I like that conclusion, because it honors the quiet labor inside real change instead of reducing everything to a performance.', zh: '這樣的結論很有力量，因為它把成長當成被活出來的東西，而不是被宣告出來的東西。' },
          { speaker: 'a', speakerName: 'Lily', en: 'That is why real trade-off matters to me now. It is not a slogan; it is a practical doorway back into alignment whenever life becomes noisy.', zh: '而且只要我還能回到那種讓自己重新對齊的做法，我通常就能慢慢找回自己真正想成為的樣子。', vocab: [{ word: 'real trade-off', def: '真實的取捨' }] },
          { speaker: 'b', speakerName: 'Tom', en: 'That feels like a strong place to end. "Professional Growth and Career Development" sounds less like an ideal image now and more like a way of living with honesty over time.', zh: '我喜歡這個收尾。它讓這個主題聽起來不像一個漂亮概念，而像一種可以長久活下去的方式。' }
        ],
      }
    ],
    keyPhrases: [
